...
import com.muse.feed.client.AuthServiceClient;
import com.muse.feed.dto.PostResponse;
import com.muse.feed.dto.UserDto;
import com.muse.feed.entity.Post;
import com.muse.feed.entity.UserInterest;
import com.muse.feed.repository.CommentRepository;
import com.muse.feed.repository.PostRepository;
import com.muse.feed.repository.ReactionRepository;
import com.muse.feed.repository.UserInterestRepository;
        ...
        embeddingService.getEmbedding(post.getContent())
                .subscribe(
                        ...
                        error -> {
                            ...
                            System.err.println("Failed to generate embedding for post " + post.getId() + ": "
                                    + error.getMessage());
                        });
    }
