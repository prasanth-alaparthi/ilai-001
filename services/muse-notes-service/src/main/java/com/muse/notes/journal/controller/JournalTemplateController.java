...
import com.muse.notes.journal.repository.JournalTemplateRepository;
...
public class JournalTemplateController {
    ...
    private final JournalTemplateRepository repo;

    public JournalTemplateController(JournalTemplateRepository repo) {
        this.repo = repo;
    }
